...
public:
    void alter_exe_file(PsxExeFile& exe, const GameData& game_data, const RandomizerWorld& world) override
    {
        ...
        check_charm_boots.lw(reg_V0, reg_V0, 0xD8A0, false);
        ...
        check_long_boots_jump.lw(reg_V0, reg_V0, 0xD898, false);
        ...
        check_long_boots_speed.lw(reg_V0, reg_V0, 0xD898, false);
        ...
        check_merman_boots.lw(reg_V0, reg_V0, 0xD89C, false);
